module.exports = {
  ...
  // Cash Drawer
  CD_KICK_2: Buffer.from([0x1b, 0x70, 0x00, 0x32, 0xfa]), // Sends a pulse to pin 2 []
  CD_KICK_5: Buffer.from([0x1b, 0x70, 0x00, 0x32, 0xfa]), // Sends a pulse to pin 5 []
  ...
  QRCODE_CORRECTION_L: Buffer.from([
    0x1d,
    0x28,
    0x6b,
    0x03,
  ...
  QRCODE_CORRECTION_M: Buffer.from([
    0x1d,
    0x28,
    0x6b,
    0x03,
  ...
  QRCODE_CORRECTION_Q: Buffer.from([
    0x1d,
    0x28,
    0x6b,
    0x03,
  ...
  QRCODE_CORRECTION_H: Buffer.from([
    0x1d,
    0x28,
    0x6b,
    0x03,
  ...
  PDF417_OPTION_STANDARD: Buffer.from([
    0x1d,
    0x28,
    0x6b,
    0x03,
  ...
  PDF417_OPTION_TRUNCATED: Buffer.from([
    0x1d,
    0x28,
    0x6b,
    0x03,
